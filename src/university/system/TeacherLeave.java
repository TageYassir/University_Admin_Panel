...
public class TeacherLeave extends JFrame implements ActionListener {
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        if (ae.getSource() == this.search) {
            ...
            try {
                Conn c = new Conn();
                ResultSet rs = c.s.executeQuery("select * from teacher where regestration = '" + regestration + "'");
        ...
        // If submit button is clicked, confirm leave and insert the request
            ...
            try {
                ...
                if (option == JOptionPane.YES_OPTION) {
                    ...
                    String query = "insert into teacherleave (regestration, name, fname, branch, leave_date) values('"
                    ...
                    String deleteQuery = "DELETE FROM teacher WHERE regestration = '" + regestration + "'";
    ...
    public static void main(String[] args) {
        new TeacherLeave();  // Open the Student Leave form
    }
}
